...
if st.session_state.mainmenu == "Logout":
    ...
    st.rerun()    
if st.session_state.mainmenu == "Manage password": st.session_state.callstack.call('pages/kairospassword.py', 'pages/kairos.py')
if st.session_state.mainmenu == "Manage settings": st.session_state.callstack.call('pages/kairossettings.py', 'pages/kairos.py')
if st.session_state.mainmenu == "Manage objects": st.session_state.callstack.call('pages/kairosobjects.py', 'pages/kairos.py')
if st.session_state.mainmenu == "Manage users and roles": st.session_state.callstack.call('pages/kairosusers.py', 'pages/kairos.py')
if st.session_state.mainmenu == "Kairos log": st.session_state.callstack.call('pages/kairosklog.py', 'pages/kairos.py')
if st.session_state.mainmenu == "Postgres log": st.session_state.callstack.call('pages/kairosplog.py', 'pages/kairos.py')
if st.session_state.mainmenu == "Web server log": st.session_state.callstack.call('pages/kairoswlog.py', 'pages/kairos.py')
if st.session_state.mainmenu == "Streamlit log": st.session_state.callstack.call('pages/kairosslog.py', 'pages/kairos.py')
if st.session_state.mainmenu == "Kairos introspection": st.session_state.callstack.call('pages/kairosintro.py', 'pages/kairos.py')
if st.session_state.mainmenu == "Kairos upgrade": st.session_state.callstack.call('pages/kairosupgrade.py', 'pages/kairos.py')
if st.session_state.mainmenu == "Documentation": st.session_state.callstack.call('pages/kairosdoc.py', 'pages/kairos.py')
